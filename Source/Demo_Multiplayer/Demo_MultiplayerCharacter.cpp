...
void ADemo_MultiplayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADemo_MultiplayerCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ADemo_MultiplayerCharacter::Look);
	...
	{
		UE_LOG(LogDemo_Multiplayer, Error, TEXT("'%s' Failed to find an Enhanced Input component! This template is built to use the Enhanced Input system. If you intend to use the legacy system, then you will need to update this C++ file."), *GetNameSafe(this));
	}
}

void ADemo_MultiplayerCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADemo_MultiplayerCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADemo_MultiplayerCharacter::DoMove(float Right, float Forward)
{
...
void ADemo_MultiplayerCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ADemo_MultiplayerCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ADemo_MultiplayerCharacter::DoJumpEnd()
{
